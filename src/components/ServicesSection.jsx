...
const services = [  
  {  
    ...
    icon: (  
      <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-gray-100 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">  
...
const ServicesSection = () => {  
  return (  
    <section id="services" className="py-24 relative bg-gray-950 text-gray-100">  
      <div className="absolute inset-0 bg-gradient-to-bl from-gray-900 via-gray-950 to-black -z-10"></div>  

      <div className="container mx-auto px-6 mb-16 text-center">  
        <h2 className="text-5xl font-extrabold text-gray-100 mb-4">What We Offer</h2>  
          ...
          {services.map((service, index) => (  
            <div key={index} className="relative w-full md:w-1/3 p-4">  
              <div className="transform transition duration-500 hover:scale-105">  
                <div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} rounded-full shadow-lg opacity-60`}></div>  
                <div className="relative z-10 p-8 text-center">  
                  {service.icon}  
                  <h3 className="text-2xl font-semibold text-gray-100 mb-2">{service.title}</h3>  
