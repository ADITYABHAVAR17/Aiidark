    ...
    <section id="contact" className="py-24 bg-gray-950">
      <div className="container mx-auto px-6 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          {/* Contact Information */}
          <div className="bg-gray-800 p-10 shadow-2xl rounded-2xl flex flex-col">
            ...
            <ul className="space-y-6 flex-grow">
              <li className="flex items-center">
                <div className="p-3 bg-gray-700 rounded-full mr-4">
                  <img
                    src="https://cdn-icons-png.flaticon.com/512/726/726443.png"
                    alt="Phone Icon"
                    className="h-6 w-6"
                  />
                </div>
                <span className="text-lg text-white">+1 (800) 123-4567</span>
              </li>
              <li className="flex items-center">
                <div className="p-3 bg-gray-700 rounded-full mr-4">
                  <img
                ...
                <span className="text-lg text-white">contact@industrial.com</span>
              </li>
              <li className="flex items-center">
                <div className="p-3 bg-gray-700 rounded-full mr-4">
                  <img
                ...
                <span className="text-lg text-white">
                  123 Industrial Blvd, Suite 100, Tech City
                </span>
              </li>
            </ul>
          </div>
          {/* Contact Form */}
          <form
            className="bg-gray-800 p-10 shadow-2xl rounded-2xl flex flex-col"
          ...
          >
            ...
            <div className="mb-8 flex-grow">
              ...
              <input
                ...
                className="w-full p-4 border border-gray-600 bg-gray-700 text-white rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500"
