...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="relative py-32 overflow-hidden bg-gradient-to-b from-white via-blue-50 to-blue-100"
    >
      {/* More visible background elements */}
      <div className="absolute top-0 left-0 w-[800px] h-[800px] rounded-full bg-blue-200/60 -translate-x-1/2 -translate-y-1/2 blur-xl animate-float"></div>
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full bg-blue-200/60 translate-x-1/2 translate-y-1/2 blur-xl animate-float-delayed"></div>

      {/* Enhanced additional background elements */}
      <div className="absolute top-1/3 right-1/4 w-72 h-72 rounded-full bg-blue-100/50 blur-lg animate-float"></div>
      <div className="absolute bottom-1/4 left-1/3 w-56 h-56 rounded-full bg-blue-100/50 blur-lg animate-float-delayed"></div>
      ...
      <div className="container relative mx-auto px-6 md:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          <h2 className="text-5xl md:text-6xl font-extrabold text-blue-900 mb-6 tracking-tight drop-shadow-sm">
            About Aii Ventures
          </h2>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-20">
          <div className="relative group">
            <div className="absolute left-0 w-[6px] h-full bg-gradient-to-b from-transparent via-blue-600 to-transparent rounded-full group-hover:via-blue-700 transition-all duration-500 shadow-lg"></div>
